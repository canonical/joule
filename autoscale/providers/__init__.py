...
class BaseProvider(ABC):
    ...
    def send_token_to_message_queue(self, event: Event, token: str) -> None:
        """
        Write the token generated by any existing instance back onto the
        provider's message queue.  This will then be consumed by a joining
        instance in order to authenticate into the application's cluster.
    ...
    def loop(self, *applications: object) -> None:
        """
